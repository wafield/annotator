...
STATIC_ROOT = os.path.join(PROJECT_PATH, '../static/annotator-evaluation/')

# URL prefix for static files.
# Example: "http://example.com/static/", "http://static.example.com/"
STATIC_URL = '/static-evaluation/'
...
SECRET_KEY = '+eq$2)shavl8aw5!w(rn+^xs!71jkz!chou!epus*fhd0dp6j2'
